...
<form class="container d-flex flex-column" action="../Controller/validaLogin.php" method="POST">
    <h1 class="mb-lg-4 text-center">Faça seu Login</h1>
    ...
    <button type="submit" class="btn btn-primary mt-4 botao">Logar</button>
</form>
</main>';
