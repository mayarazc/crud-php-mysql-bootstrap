...
criarTopo($css);
  ...
  <form class="container d-flex flex-column formulario" method="POST" action="../Controller/editarAvaliacao.php?cod='.$dado[0]["cod"].'">
    <h1 class="display-6 text-center mb-4">Avalie</h1>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control mb-4 mt-2" id="textarea" rows="5" name="review">'.$dado[0]["review"].'</textarea>
        </div>
